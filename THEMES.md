...
It is preserved here so the definitions are not lost while the specification is being reworked.

## Theme Definitions

The theme definitions below were the canonical source for theme meaning, lead ownership, collaborator desks, relevance boundaries, and primary drivers in the previous model.
